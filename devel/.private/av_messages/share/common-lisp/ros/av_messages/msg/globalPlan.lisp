...
(cl:defmethod cl:initialize-instance :after ((m <globalPlan>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'globalPlan)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name av_messages-msg:<globalPlan> is deprecated: use av_messages-msg:globalPlan instead.")))
...
(cl:defmethod waypoints-val ((m <globalPlan>))
