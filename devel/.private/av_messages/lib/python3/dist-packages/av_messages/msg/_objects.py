...
"""autogenerated by genpy from av_messages/objects.msg. Do not edit."""
import codecs
import sys
...
class objects(genpy.Message):
  _md5sum = "29c2393b11acc79632a74bbd645a8019"
  _type = "av_messages/objects"
...
int16 data
"""
  __slots__ = ['header','object_detections']
  _slot_types = ['std_msgs/Header','av_messages/object[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.object_detections)
      buff.write(_struct_I.pack(length))
      for val1 in self.object_detections:
        _v1 = val1.position
        _x = _v1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.object_detections.append(val1)
      return self
