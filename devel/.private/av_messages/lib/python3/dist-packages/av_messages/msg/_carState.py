...
"""autogenerated by genpy from av_messages/carState.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','geometry_msgs/Pose2D','av_messages/carStateDT']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.car_state_dt is None:
        self.car_state_dt = av_messages.msg.carStateDT()
    else:
      self.header = std_msgs.msg.Header()
      self.car_state = geometry_msgs.msg.Pose2D()
      self.car_state_dt = av_messages.msg.carStateDT()
