...
"""autogenerated by genpy from av_messages/map.msg. Do not edit."""
import codecs
import sys
...
import av_messages.msg
import geometry_msgs.msg
import std_msgs.msg

class map(genpy.Message):
  _md5sum = "507b8d3aceb65739aa0ff50d944e3b63"
  _type = "av_messages/map"
...
# tbd"""
  __slots__ = ['header','obstacles','drivable_route']
  _slot_types = ['std_msgs/Header','av_messages/object[]','av_messages/laneDetections']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,obstacles,drivable_route
    ...
    if args or kwds:
      ...
      if self.obstacles is None:
        self.obstacles = []
      if self.drivable_route is None:
        self.drivable_route = av_messages.msg.laneDetections()
    else:
      self.header = std_msgs.msg.Header()
      self.obstacles = []
      self.drivable_route = av_messages.msg.laneDetections()
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v20.data,) = _get_struct_h().unpack(str[start:end])
        self.obstacles.append(val1)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
